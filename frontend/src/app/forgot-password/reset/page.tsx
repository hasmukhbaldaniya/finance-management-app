...
import { useForgotPassword } from "../forgot-password-context";
    ...
    <AuthCard title="Reset password" description="Choose a new password for your account.">
      <form onSubmit={handleSubmit} noValidate className="space-y-4">
        ...
        <div className="flex items-center justify-between text-sm">
          <Link href="/forgot-password/verify" className="text-primary underline-offset-4 hover:underline">
            ← Back
          </Link>
          <Link href="/login" onClick={reset} className="text-primary underline-offset-4 hover:underline">
            Back to Login
          </Link>
        </div>
      </form>
