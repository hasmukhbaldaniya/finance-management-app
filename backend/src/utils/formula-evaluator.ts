...
// codebase's security rules. The grammar is already constrained at
// category-configuration time (category-fields.controller.ts's own
// isValidFormula): digits, whitespace, + - * / ( ), and {{FieldName}}
// tokens, so this only needs to parse that narrow subset.
