...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("expense_split_requests", {
      ...
      // requestedByEmployeeId — auth-service's Employee, cross-service, no
      // FK (see claim-service/CLAUDE.md's "Cross-service reads").
    ...
    await queryInterface.createTable("expense_split_request_members", {
      ...
      // employeeId — auth-service's Employee, cross-service, no FK.
      employeeId: {
        type: Sequelize.INTEGER,
        allowNull: false,
      },
