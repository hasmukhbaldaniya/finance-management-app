// Ported from frontend/src/components/category/basic-details-form.tsx.
// next/navigation's useRouter -> react-router's useNavigate.
...
export function BasicDetailsForm() {
  ...
  async function handleSaveAsDraft(): Promise<void> {
    ...
    try {
      ...
      navigate(ROUTES.COMPANY_SETTINGS.CATEGORIES);
    } catch (error) {
  ...
  async function handleSaveAndContinue(): Promise<void> {
    ...
    try {
      ...
      navigate(ROUTES.categoryStep(id, CATEGORY_STEP_SEGMENTS.expenseForm));
    } catch (error) {
