// Ported from frontend/src/app/(public)/onboarding/page.tsx.
// next/navigation's useRouter/useSearchParams -> react-router's
// useNavigate/useSearchParams (same .get() usage). The outer <Suspense>
// wrapper is dropped, same reasoning as CategoryNewScreen: it existed only
// because Next requires useSearchParams() to be wrapped in Suspense, which
// react-router's own useSearchParams has no equivalent requirement for.
