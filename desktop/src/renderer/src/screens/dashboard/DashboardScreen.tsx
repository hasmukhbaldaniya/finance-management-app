// Ported from frontend/src/app/(private)/dashboard/page.tsx verbatim — no
// Next imports in the original at all, so this is a straight copy with just
// the default export turned into a named one (matching every other screen
// in this app).
