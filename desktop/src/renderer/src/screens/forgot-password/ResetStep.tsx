// Ported from frontend/src/app/(public)/forgot-password/reset/page.tsx.
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      if (err instanceof ApiError && err.status === 401) {
        leaveAndReset();
        navigate(ROUTES.FORGOT_PASSWORD.REQUEST);
      }
    } finally {
    ...
    <AuthCard title="Reset password" description="Choose a new password for your account.">
      <Stack component="form" onSubmit={handleSubmit} noValidate spacing={2}>
        ...
        <Stack direction="row" sx={{ alignItems: "center", justifyContent: "space-between" }}>
          <MuiLink component={Link} to={ROUTES.FORGOT_PASSWORD.VERIFY} underline="hover" variant="body2">
            ← Back
          </MuiLink>
