// Ported from frontend/src/app/(public)/forgot-password/page.tsx.
...
export function ForgotPasswordRequestStep() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      navigate(ROUTES.FORGOT_PASSWORD.VERIFY);
    } catch (err) {
    ...
    <AuthCard title="Forgot password" description="Enter your email to receive a one-time password.">
      <Stack component="form" onSubmit={handleSubmit} noValidate spacing={2}>
        ...
        <Typography align="center" variant="body2">
          <MuiLink component={Link} to={ROUTES.LOGIN} onClick={reset} underline="hover">
            Back to Login
          </MuiLink>
        </Typography>
      </Stack>
