// Ported from frontend/src/app/(public)/login/page.tsx. next/link's Link ->
// react-router's Link (href= -> to=); next/navigation's useRouter ->
// react-router's useNavigate. Everything else — validation, the API call,
// the toast-on-error handling — is unchanged.
    ...
    <AuthCard title="Log in" description="Access your dashboard.">
      <Stack component="form" onSubmit={handleSubmit} noValidate spacing={2}>
        ...
        <Typography align="center" variant="body2">
          <MuiLink component={Link} to={ROUTES.FORGOT_PASSWORD.REQUEST} underline="hover">
            Forgot password?
          </MuiLink>
        </Typography>

        <Typography align="center" variant="body2">
          <MuiLink component={Link} to={ROUTES.REGISTER.ORGANIZATION} underline="hover">
