// Ported from frontend/src/app/(private)/company-settings/grades/page.tsx
// verbatim — zero Next imports in the original. This is the reference CRUD
// implementation for this whole cluster; Departments and Roles are
// near-copies of this same shape.
