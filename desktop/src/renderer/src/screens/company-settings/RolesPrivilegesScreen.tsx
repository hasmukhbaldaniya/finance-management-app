// Ported from frontend/src/app/(private)/company-settings/roles-privileges/page.tsx
// verbatim — zero Next imports; same CRUD shape as Grades/Departments plus
// the read-only view-dialog for the 2 seeded default roles.
...
export function RolesPrivilegesScreen() {
