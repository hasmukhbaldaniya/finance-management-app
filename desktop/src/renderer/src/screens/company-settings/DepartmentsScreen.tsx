// Ported from frontend/src/app/(private)/company-settings/departments/page.tsx
// verbatim — zero Next imports; a near-copy of GradesScreen with the noun
// swapped, matching frontend/'s own documented pattern.
