// Ported from frontend/src/app/(private)/company-settings/employees/invite/page.tsx.
// next/link -> react-router's Link; next/navigation's useRouter -> useNavigate.
// Everything else — the single-page multi-section model where every field is
// editable in any order and nothing saves until "Send Invite" — is unchanged.
...
export function EmployeeInviteScreen() {
