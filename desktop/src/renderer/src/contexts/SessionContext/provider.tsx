// Ported from frontend/src/contexts/SessionContext/provider.tsx. The one
// real change in all 5 ported contexts (per the plan's exploration):
// next/navigation's useRouter() -> react-router's useNavigate(), and
// router.replace(ROUTES.LOGIN) -> navigate(ROUTES.LOGIN, { replace: true }).
// Everything else — the getMe() bootstrap, the loading/error states, the
